...
% disagree(StapledResponse, OcspResponse):-
%     Fingerprint = "aa",
%     SANList = ["www.bing.com"],
%     Subject = "",
%     Lower = 1617423689,
...
%     % CertPolicies = [["1.3.6.1.4.1.6334.1.100.1", 0]],
%     CertPolicies = [],
%     firefox:stapledResponse(StapledResponse),
%     firefox:ocspResponse(OcspResponse),
%     % StapledResponse = [verified, not_expired, valid],
%     % OcspResponse = [],
%     RootSubject = ["Cybertrust Global Root", "", "", "", "Cybertrust, Inc"],
%     RootFingerprint = "806900450323811634B49508D427C5C5F7BEC6733DD369FB2F6B7A4EA228223A",
...
% both(Fingerprint, SANList, Subject, Lower, Upper, Algorithm, BasicConstraints, KeyUsage, ExtKeyUsage, CertPolicies, StapledResponse, OcspResponse, RootSubject, RootFingerprint, RootLower, RootUpper, RootBasicConstraints, RootKeyUsage):-
both():-
    Fingerprint = "",
    SANList = ["www.bing.com"],
    Subject = "",
    ...
    KeyUsage = [],
    ExtKeyUsage = [],
    CertPolicies = ["1.3.6.1.4.1.6334.1.100.1"],
    StapledResponse = [verified, not_expired, valid],
    OcspResponse = [],
    RootSubject = ["Cybertrust Global Root", "", "", "", "Cybertrust, Inc"],
